...
Two functions are provided: Copy UI and Merge Journals.

## Copy UI
Copy UI Takes a template windows.json file (controls all window placement) and chats.json file (controls chat tabs and filters) and copies them to all characters in the MnM game directory. This allows you to set up a template UI and quickly apply it to the game.
